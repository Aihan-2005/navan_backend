...
urlpatterns = [
    ...
    path(
        "sessions/<uuid:session_id>/turns/",
        views.SpeakingTurnCreateView.as_view(),
        name="turn-create",
    ),
    path(
        "sessions/<uuid:session_id>/turns/<uuid:pk>/",
        views.SpeakingTurnDetailView.as_view(),
        name="turn-detail",
    ),
    path(
        "sessions/<uuid:session_id>/complete/",
        views.SpeakingSessionCompleteView.as_view(),
        name="session-complete",
    ),
    path(
        "sessions/<uuid:session_id>/evaluation/",
        views.SpeakingEvaluationDetailView.as_view(),
